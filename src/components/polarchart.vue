...
export default {
  name: 'polarChart',
  data() {
    return { configdata: config, skills: null, skillPoints: null };
  },
  mounted() {
    ...
    renderChart() {
      ...
      new Chart(ctx, {
        ...
        options: {
            ...
            tooltip: {
              ...
              callbacks: {
                label: function(context) {
                  return `${context.label}: ${context.raw} 技能点`;
                },
          ...
          animation: { duration: 1800, easing: 'easeOutQuad', animateRotate: true, animateScale: true },
        },
      });
    },
  },
